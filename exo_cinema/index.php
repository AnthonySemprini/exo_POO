...
$film6 = new Film("Indiana Jones et le temple maudit",1984,118,$realisateur3,"Aventure","L'archéologue aventurier Indiana Jones est de retour. Il poursuit une terrible secte qui a dérobé un joyau sacré doté de pouvoirs fabuleux. Une chanteuse de cabaret et un époustouflant gamin l'aideront a affronter les dangers les plus insensés.");

$film7 = new Film("Indiana Jones et la derniere croisade",1989,127,$realisateur3,"Aventure","L'archéologue aventurier Indiana Jones se retrouve aux prises avec un maléfique milliardaire. Aux côtés de la cupide Elsa et de son père, il part à la recherche du Graal.");
